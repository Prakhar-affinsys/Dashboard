"""
Django settings for django_dah project.
...
SECRET_KEY = 'django-insecure-rd1^2=27(vjv_8ij)-wmfqfahhuya_0hn$81or-g&8=q@h2yl#'
...
WSGI_APPLICATION = 'django_dah.wsgi.application'
...
ASGI_APPLICATION = 'django_dah.routing.application'
#
